;(function(cn){
    ...
    //      npm install --registry=https://npm.services.local
    //  Compilation "browsing" du consent string sdk : (prérequis npm install -g browserify --registry=https://npm.services.local)
    //      npm run build
    ...
    var _init = function (will_revalidate) {
        ...
        __cmp._create_banner = function() {
            ...
            document.getElementById('scmp-btn-parameters').addEventListener('click', function(){
                document.getElementById('scmp-popin').classList.add('scmp-parameters-open'),
                document.getElementById('scmp-parameters').classList.remove('scmp-hidden'),
                document.getElementById('scmp-btn-parameters').classList.add('scmp-hidden'),
                document.getElementById('scmp-overlay').classList.remove('scmp-hidden'),
                document.getElementsByTagName('body')[0].classList.add('scmp-no-scroll')
            });
            document.getElementById('scmp-btn-validation').addEventListener('click', function(){
                document.getElementById('scmp-popin').classList.add('scmp-hidden'),
                document.getElementsByTagName('body')[0].classList.remove('scmp-no-scroll')
